    ...
    <div class="footer-hearder">
        <div class="grid wide">
            <div class="row sm-gutter">
                <div class="col l-3 m-12 c-12 container-shoping__culum-75">
                    <div class="footer-hearder__list">
                        <p class="footer-hearder__span-p">
                            Stackoverflow – Kênh mua sắm đồ công nghệ cao cấp
                        </p>
                        <p class="footer-hearder__span-p">
                ...
                <div class="col l-3 m-12 c-12 container-shoping__culum-75">
                    <div class="footer-hearder__list">
                        ...
                        <h2>VỀ Stackoverflow</h2>
                        <span class="footer-hearder__span">
                            <a href="#" class="footer-hearder__link">
                                Giới thiệu về  Stackoverflow
                            </a>
                        </span>
                        <span class="footer-hearder__span">
                            <a href="#" class="footer-hearder__link">
                        ...
                        <span class="footer-hearder__span">
                            <a href="#" class="footer-hearder__link">
                                Sản phẩm ở  Stackoverflow
                            </a>
                        </span>
                        <span class="footer-hearder__span">
                            <a href="#" class="footer-hearder__link">
                                Vì sao chọn  Stackoverflow?
                            </a>
                        </span>
                        <span class="footer-hearder__span">
                            <a href="#" class="footer-hearder__link">
                ...
                <div class="col l-3 m-12 c-12 container-shoping__culum-75">
                    <div class="footer-hearder__list">
                        ...
                        <a href="#" class="footer-hearder__flex-list-link">
                            <img src="{{'?= $baseUrl ?'}}assets/images/anh7.png" alt=""
                                 class="footer-hearder__flex-list-img">
                        </a>
                        <p class="footer-hearder__span-p">
            ...
            <p class="footer-hearder__footer footer-hearder__span-p">
                Copyright 2021 © | Giao diện web đẹp | Stackoverflow
            </p>
        </div>
    </div>
</div>
