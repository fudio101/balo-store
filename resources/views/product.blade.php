        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="{{route('product',1)}}"><img src="{{asset('assets/img/products/product-img-2.jpg')}}" alt=""></a>
                        </div>
                        <h3>Berry</h3>
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="{{route('product',1)}}"><img src="{{asset('assets/img/products/product-img-3.jpg')}}" alt=""></a>
                        </div>
                        <h3>Lemon</h3>
